This is a k8s deployment project consisting of a web-server propped up by a python script, converting temperatures, and front-ended by a NodePort service exposing it to the outside world.
